...
#define MS_PER_CYCLE 4000  //the number of milliseconds per animation cycle
...
main( int argc, char *argv[ ] )
{
    ...
    /*glBindTexture( GL_TEXTURE_2D, Tex1 ); // make the Tex1 texture current and set its parameters
...
Display( )
{
    ...
    glLoadIdentity( );
    glColor3f( 1., 1., 1. );
    DoRasterString( 5., 5., 0., (char *)"Distorting" );*/
...
InitGraphics( )
{
    ...
    //unsigned char * TextureArray1 = BmpToTexture( "worldtex.bmp", &width1, &height1 );
